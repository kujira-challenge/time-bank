...
2. **招待されたメールアドレス**を入力
3. 「ログインリンクを送信」をクリック
4. メールボックスに届いた Magic Link をクリック
5. 自動的にログインされ、プロフィールが作成されます

**注意**:
- 招待されていないメールアドレスではログインできません
- Magic Link の有効期限は1時間です
- パスワードは不要です（メールのリンクだけでログイン可能）

### 6.3 再ログイン（2回目以降）

1. `/login` ページにアクセス
2. メールアドレスを入力して「ログインリンクを送信」をクリック
3. メールに届いた Magic Link をクリックしてログイン

### 6.4 Magic Link が届かない場合
